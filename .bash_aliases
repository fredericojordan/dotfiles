...
alias hld="heroku logs -a su-directory-backend-dev bash"
alias hlq="heroku logs -a su-directory-backend-qa bash"
alias hlp="heroku logs -a su-directory-backend bash"
